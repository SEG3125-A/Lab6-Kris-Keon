...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var color = readData("FirstName");
        var fruit = readData("LastName");
        var animal = readData("drawnToFirst");
        var animal = readData("success");
        var animal = readData("notLike");
        var animal = readData("advice");
        res.render('showResults', {results: [FirstName, LastName, drawnToFirst, success, notLike, advice]});
        console.log([FirstName, LastName, drawnToFirst, success, notLike, advice]);
    });
